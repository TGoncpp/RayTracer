...
#pragma region SCENE W1
	void Scene_W1::Initialize()
	{
		...
		AddSphere({ 25.f, 0.f, 100.0f }, 50.f, matId_Solid_Blue);
		...
		//
		////test implementaions
		//std::cout << Vector3::Dot(Vector3::UnitX, Vector3::UnitX) << std::endl;
		//std::cout << Vector3::Dot(Vector3::UnitX, Vector3::UnitY) << std::endl;
		//std::cout << Vector3::Dot(Vector3::UnitX, -Vector3::UnitX) << std::endl;

		//Vector3 crossVec1 =  Vector3::Cross(Vector3::UnitZ, Vector3::UnitX);
		//std::cout << crossVec1.x <<"x " << crossVec1.y << "y " << crossVec1.z << "z " << std::endl;
...
#pragma region SCENE W3
	...
	void Scene_W3::Initialize()
	{
		...
		const auto mathLambertPong1 = AddMaterial(new Material_LambertPhong(colors::Blue, 0.5f, 0.5f, 3.f));
		const auto mathLambertPong2 = AddMaterial(new Material_LambertPhong(colors::Blue, 0.5f, 0.5f, 15.f));
		const auto mathLambertPong3 = AddMaterial(new Material_LambertPhong(colors::Blue, 0.5f, 0.5f, 50.f));
		...
		//AddSphere(Vector3{ -1.75f, 1.f, 0.f },.75f, mathLambertPong1);
		//AddSphere(Vector3{ 0.f, 1.f, 0.f },   .75f, mathLambertPong2);
		//AddSphere(Vector3{ 1.75f, 1.f, 0.f }, .75f, mathLambertPong3);
...
#pragma region SCENE W4
	...
	void Scene_W4_TestScene::Update(Timer* pTimer)
	{
		...
		pMesh->RotateY(dae::PI_DIV_2 * pTimer->GetTotal());
		pMesh->UpdateTransforms();
	}
